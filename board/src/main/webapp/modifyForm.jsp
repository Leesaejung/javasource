...
<%-- 			<div class="col-sm-10">
			...
			<%-- 
				파일명에 ++ 와 같이 특수문자가 들어있거나 하는 경우에는 다운로드 요청 시 문제가 생김 
				
			--%>
			<div class="col-sm-10">
			<%
				// 다운로드 받을 파일명 가져오기 => EL과 java 코드가 호환 x
		...
		<input type="hidden" name="bno" value="${dto.bno}" /> <!-- java.lang.NumberFormatException: null => bno를 안 넘겨줘서 발생한 오류 -->
