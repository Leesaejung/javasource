...
public class StudentEx2 {
	...
	public static void main(String[] args) {
		...
		//초기화 필요
		stuArr[0]=new Student2("홍길동", 1, 1, 70, 80, 90);
		stuArr[1]=new Student2("성춘향", 1, 2, 100, 100, 90);
		stuArr[2]=new Student2("서유기", 1, 3, 50, 50, 50);
		stuArr[3]=new Student2("김미남", 1, 4, 90, 60, 80);
		stuArr[4]=new Student2("이서진", 1, 5, 80, 90, 90);
