...
public class SerializationEx1 {
	public static void main(String[] args) {
		...
		try(FileOutputStream fos = new FileOutputStream("c:\\temp\\serial.dat");
			...
			ObjectOutputStream oos = new ObjectOutputStream(bos)) { //객체를 쓰려면 ObjectOutputStream 써야 함, 객체를 저장할 수 있다
		...
		try(FileInputStream fos = new FileInputStream("c:\\temp\\serial.dat");
			...
			ObjectInputStream oos = new ObjectInputStream(bos)) { //객체를 쓰려면 ObjectOutputStream 써야 함, 객체를 저장할 수 있다
